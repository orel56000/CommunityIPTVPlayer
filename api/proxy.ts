...
export default async function handler(request: Request): Promise<Response> {
  ...
  copyHeader(request.headers, upstreamRequestHeaders, "accept-language");
  copyHeader(request.headers, upstreamRequestHeaders, "cache-control");
  copyHeader(request.headers, upstreamRequestHeaders, "if-none-match");
  copyHeader(request.headers, upstreamRequestHeaders, "if-modified-since");
